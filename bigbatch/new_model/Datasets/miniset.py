...
def download_minst(save_dir: str = None) -> bool:
    """download MNIST dataset
    input:
        save_dir: save dir of mnist dataset , string

    return:
        all successfully download, ture. false else.
    """
...
if __name__ == "__main__":
	download_minst(save_dir="/home/ubuntu/xlj/optimization/Datasets/")
