...
if mod(iter,interval) ==0  %每隔interval次算一下终止准则/更新beta eta
    ...
    fprintf('num:%i,iter:%i,r:%f,d_XY:%f\n',n,iter,r,d_xy)
    end
    ...
    if mod(iter,1) == 0 % samll case, print each iter
    fprintf('iter:%i, phase: %i,nnzY: %i,beta:%4.2g,eta:%4.2g,dxy:%4.2g,dy:%4.2g,r:%4.2g\n',iter,phase,nnz(y),beta,eta,dxy,dy,r)  
    end
