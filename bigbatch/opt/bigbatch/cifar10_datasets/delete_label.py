...
save_dir = "/home/ubuntu/xlj/opt/bigbatch/cifar10_datasets/train_gray_wo_label.txt"
# 数据路径前缀
...
# 组合图片路径和标签，并添加前缀
data = [(f"{prefix}{image}") for image, label in zip(annotations["images"], annotations["categories"])]
